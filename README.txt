...
## Случайные встречи на тропинке: зайчики (2р), птички (1р), мышки (1р) и заметный издалека указательный камень (5р, один на каждом перепутье) (колобок неграмотный и читать не умеет, но жрет все подряд)   
