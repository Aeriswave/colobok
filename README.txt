...
## Случайные встречи на тропинке: зайчики (2р), птички (1р), мышки (1р) и заметный издалека (аж с соседней локации) указательный камень (5р, один на каждом перепутье) (колобок неграмотный и читать не умеет, но жрет все подряд)   
## Дальше катится колобок и попадает:   
## к лисе (4р), к волку (6р), к медведю (р8), к деду с бабкой (р7+р8), на новое перепутье   
## действие колобка: выслушать, покатиться дальше, вернуться в деревню (бабка 7, дедка 8), попытаться слопать первого встречного   
