...
- Оглавление   
      ...
      ###Полное оглавление   
      > @@   //ненумерованное оглавление   
      > №@@   //нумерованное по разделам оглавление   
      > +@@   //оглавление с номерами страниц, заданных в виде ссылок   
      >
      ###Выборочное оглавление   
      > @@[ID_оглавления_уровня0]   
      > №@@[ID_оглавления_уровня1]   
      >   
      ...
      > @@[ID_оглавления_уровня0](название файла0)   
      > №@@[ID_оглавления_уровня1](название файла1)   
      > №№@@[ID_оглавления_уровня2](название файла2)   
      > ##*@@[ID_оглавления_уровня3](название файла3)   
      > №@@(название файла4)   
      > №[СписокШиндлера]@@(название файла7)   // оглавление, включенное в нумерованный список "СписокШиндлера" 
      > @@@(название файла8)   //оглавление файла8 с номерами страниц, заданных в виде ссылок   
      > №№@@@(название файла9)   //оглавление файла9 с номерами разделов и номерами страниц, заданных в виде ссылок   
      >   
...
- Именованные и неименованные разделы, границы раздела показывать через фигурные скобки, граница блока без фигурных скобок = от начала блока до начала следующего блока:   
      // Описание раздела   
      ~[+](Название раздела без идентификатора)   
      ~[ID_раздела](Название именованного раздела)   
      уровень вложенности раздела определяется числом символов ~~~~~~   
- Заголовки и Списки (нумерованные и маркированные)   
--- нумерованные: уровень (по количеству символов "№")  в нем [ИмяСписка]:   
      ...
      > № Второй нумерованный   
      > №№ Третий нумерованный   
      > №[СписокШиндлера, СШ] строка списка 1 уровня   // СШ - название префикса списка, добавляемое перед номером списка   
      ...
      > 3. Третий нумерованный   
      > СШ 1. строка списка 1 уровня   
      > СШ 2. строка списка 1 уровня   
      > СШ 2.1. строка списка 2 уровня   
      > СШ 2.2. строка списка 2 уровня   
      > СШ 3. строка списка 1 уровня   
      >   
--- маркированные:   
      уровень_списка маркер:   
      уровень_списка[Опциональное ID_Списка]маркер:   
      пример:   
      > #* строка X списка 1 уровня   
      > #+ строка Y списка 1 уровня   
...
- Ссылки и сноски
         ...
         +[ID_Имя_ссылки]{гиперссылка} // объявить ссылку   
         +[ID_Имя_ссылки](описание ссылки A){гиперссылка на внешний ресурс}   
         > +[ссылка1](Текст описания ссылки 1)  // объявить ссылку   
         > ++[ID_Имя_ссылки] // отобразить описание ссылки   
         > ++[ID_Имя_ссылки](замещающий текст) // отобразить замещающий текст с гиперссылкой   
         >   
         Отображается как:   
         ...
         +[ID_Имя_ссылки](Текст описания сноски) // объявить сноску/ссылку на используемую литературу   
         > +[название](Текст описания ненумерованной сноски)  // объявить сноску   
         > ++[ID_Имя_сноски](№)  // отобразить номер сноски (и текст подсказки с описанием сноски)   
         >   
         Отображается как:   
...
## суперспособность лисы - чарующий голос, завлекающий мелких колобков (1...3р и даже 4р) на верную погибель    
