...
## Случайные встречи на тропинке: зайчики (3р), птички (2р), мышки (1р) и заметный издалека (аж с соседней локации) указательный камень (5р, один на каждом перепутье) (колобок неграмотный и читать не умеет, но жрет все подряд)   
