...
## на каждом перепутье выбор из 2 направлений (к одному из зверей, либо на другое перепутье, либо домой)   
## от каждого из зверей есть дорога в деревню (к курам, барану, пчелам) и тропинка на другое перепутье и тропинка к другому зверю       
## Катится колобок по дорожке, оказывается на перепутье и встречает там:
## Случайные встречи на тропинке: зайчики (3р), птички (2р), мышки (2р)   
## Дальше катится колобок и попадает:
## к лисе (4р), к волку (5р), к медведю (р8), к деду с бабкой (р6+р7), на новое перепутье   
## действие колобка: выслушать, покатиться дальше, вернуться в деревню (бабка 6, дедка 7), попытаться слопать первого встречного   
## если слопать, то увеличивается размер колобка (+2, +3, +4, +5, +6), в зависимости от размера животного   
## если укатиться, то колобок худеет на 1 размер   
## если размер встреченного животного больше, чем у колобка, то при попытке слопать конец рассказа   
## если заслушаться животного такого же размера, то животное съест колобка   
## изначальный размер колобка 3      
